...
public class NuevoMenuPrincipalColumnas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nuevo_menu_principal_columnas);
        ...
        nombreUsuario = "Enric";
        emailUsuario = "enric@admin.com";
        usuarioPerfil = new NuevoUsuarioPerfil(nombreUsuario, emailUsuario);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_nuevo_menu_principal_columnas, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_nuevo_menu_principal_columnas, container, false);
